...
const AuroraEffect = () => (
  <>
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, 60, -30, 0], y: [0, -40, 30, 0], scale: [1, 1.3, 0.85, 1], opacity: 1 }}
      transition={{ default: { duration: 18, repeat: Infinity, ease: 'easeInOut' }, opacity: { duration: 1.5, ease: 'easeInOut' } }}
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, -40, 60, 0], y: [0, 50, -30, 0], scale: [1, 0.8, 1.2, 1], opacity: 1 }}
      transition={{ default: { duration: 22, repeat: Infinity, ease: 'easeInOut', delay: 4 }, opacity: { duration: 1.5, ease: 'easeInOut', delay: 4 } }}
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, 30, -50, 0], y: [0, 40, -20, 0], opacity: 1 }}
      transition={{ default: { duration: 16, repeat: Infinity, ease: 'easeInOut', delay: 8 }, opacity: { duration: 1.5, ease: 'easeInOut', delay: 8 } }}
...
const GradientMeshEffect = () => (
  <>
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, 40, 0], y: [0, -30, 0], opacity: 1 }}
      transition={{ default: { duration: 12, repeat: Infinity, ease: 'easeInOut' }, opacity: { duration: 1.5, ease: 'easeInOut' } }}
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, -30, 0], y: [0, 40, 0], opacity: 1 }}
      transition={{ default: { duration: 14, repeat: Infinity, ease: 'easeInOut', delay: 2 }, opacity: { duration: 1.5, ease: 'easeInOut', delay: 2 } }}
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, 20, -20, 0], y: [0, -20, 20, 0], opacity: 1 }}
      transition={{ default: { duration: 10, repeat: Infinity, ease: 'easeInOut', delay: 5 }, opacity: { duration: 1.5, ease: 'easeInOut', delay: 5 } }}
