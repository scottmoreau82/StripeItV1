...
const themedRegistry: Record<IconTheme, Partial<Record<IconName, any>>> = {
  ...
  [IconTheme.PHOSPHOR]: {
    ...
    badge: Phosphor.Badge,
    inbox: Phosphor.Inbox,
  ...
  [IconTheme.TABLER]: {
    ...
    plusCircle: Tabler.IconPlusCircle,
    minusCircle: Tabler.IconMinusCircle,
    ...
    layers: Tabler.IconLayersIntersect,
    timer: Tabler.IconTimer,
    badge: Tabler.IconBadge,
  ...
  [IconTheme.HEROICONS]: {
    ...
    feedback: HeroIcons.ChatBubbleBottomCenterPlusIcon,
